...
import { Calendar, Clock, MapPin, CheckCircle2, Star, Loader2, Award, ShieldCheck } from 'lucide-react';
      ...
      {bookings.length === 0 ? (
        ...
        <div className="space-y-8">
          {bookings.map((booking) => (
            <div key={booking.id} className="bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/40 overflow-hidden hover:shadow-2xl hover:border-gray-200/50 transition-all duration-300">
              <div className="p-6 sm:p-8">
                ...
                {(booking.status === 'NEW' || booking.status === 'ASSIGNED') && (
                  <div className="mt-6 bg-indigo-50/30 border border-indigo-100 rounded-2xl p-4 text-left">
