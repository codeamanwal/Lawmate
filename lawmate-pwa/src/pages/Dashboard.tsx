          ...
          <div className="bg-white rounded-[32px] w-full max-w-md p-6 sm:p-8 shadow-2xl border border-gray-100 relative animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleEmergencyCaseSubmit} className="space-y-4">
              ...
              <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-xl p-3">
                ...
                <p className="text-xs font-semibold text-amber-700">A consultation fee of ₹500 is required to activate the 60-min SLA and connect you with an expert lawyer.</p>
              </div>
              ...
              >
                {emergencyLoading ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Zap className="w-5 h-5" /> Create Case & Pay ₹500</>}
              </button>
            </form>
          </div>
        </div>
