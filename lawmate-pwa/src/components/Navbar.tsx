      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link to="/pricing" className="text-gray-500 hover:text-indigo-600 font-bold text-sm transition-colors uppercase tracking-widest text-[10px]">Pricing</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-5 shadow-lg animate-in slide-in-from-top duration-200">
          <div className="flex flex-col gap-4">
            ...
            <Link to="/pricing" className="text-gray-600 hover:text-indigo-600 font-bold text-sm block px-2 py-1" onClick={() => setIsOpen(false)}>Pricing</Link>
