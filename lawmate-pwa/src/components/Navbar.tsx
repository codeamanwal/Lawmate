        ...
        <div className="md:hidden bg-white border-t border-gray-100 px-4 py-4 space-y-4 shadow-lg animate-in slide-in-from-top duration-200">
          {user ? (
            <div className="flex flex-col gap-4">
              <Link 
                to={user.role === 'LAWYER' ? "/lawyer/dashboard" : "/dashboard"} 
                className="text-gray-600 hover:text-indigo-600 font-bold text-sm block px-2"
              ...
              <button 
                ...
                className="flex items-center gap-2 text-red-600 font-bold text-sm px-2"
              >
            ...
            <div className="flex flex-col gap-4 px-2">
              ...
              <Link 
                to="/auth" 
                className="bg-indigo-600 text-white px-5 py-3 rounded-xl font-bold hover:bg-indigo-700 transition-all shadow-sm text-center text-sm"
                onClick={() => setIsOpen(false)}
              >
                Sign In
              </Link>
